...
&endif
{
				...
				LET tmp = gl_lookup( "customers",
					"customer_num,company,fname,lname,state",
					"Key~5,Company~25,First~15,Last~15,St~2",
					"ICCCC",
					"1=1",
					"lname")
